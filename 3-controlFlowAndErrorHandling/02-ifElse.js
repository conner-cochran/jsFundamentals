...
if(name1== 'Conner'){
    ...
    console.log('Hello, is your name '+ name1 +'?');
}
...
if(name[0]=== name[0].toUpperCase()){
    ...
    console.log(name.toLowerCase().substring(1));
}
...
//Gold
if(name[0]== name[0].toUpperCase()){
    console.log(name.charAt(0)+ name.toLowerCase().substring(1));
} else{
    console.log(name.charAt(0).toUpperCase()+ name.toLowerCase().substring(1));
    }

let address= "Pendleton, IN";
